...
scene.setBackgroundImage(img`
    ...
    dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
    `)
mySprite2 = sprites.create(assets.image`Pinata`, SpriteKind.Player)
mySprite = sprites.create(assets.image`paddle up`, SpriteKind.Player)
mySprite.setPosition(95, 75)
counter = 0
info.startCountdown(10)
game.splash("Piñata!", "by Adrian")
game.splash("Smash A to win")
